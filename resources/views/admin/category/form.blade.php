      ...
      <div class="box-body row">
        <div class="col-md-8 col-md-offset-2">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="cate-name" name="cate_name" placeholder="Category name">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="description" rows="6" placeholder="category description" class="form-control" id="description"></textarea>
            </div>
          </div>
